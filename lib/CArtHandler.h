...
private:
	...
	static void addSlot(CArtifact * art, const std::string & slotID);
	static void loadSlots(CArtifact * art, const JsonNode & node);
	static void loadClass(CArtifact * art, const JsonNode & node);
	static void loadType(CArtifact * art, const JsonNode & node);
	void loadComponents(CArtifact * art, const JsonNode & node);
	static void loadGrowingArt(CGrowingArtifact * art, const JsonNode & node);
...
private:
	...
	static void serializeJsonCreature(JsonSerializeFormat & handler, CMap * map);
	static void serializeJsonCommander(JsonSerializeFormat & handler, CMap * map);
