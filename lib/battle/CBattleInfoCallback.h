...
public:
	...
	static bool isEnemyUnitWithinSpecifiedRange(BattleHex attackerPosition, const battle::Unit * defenderUnit, unsigned int range) ;
	...
	static bool isToReverse(const battle::Unit *attacker, const battle::Unit *defender) ; //determines if attacker standing at attackerHex should reverse in order to attack defender
